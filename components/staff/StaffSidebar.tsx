      ...
      >
        ...
        <div className="flex items-center justify-between h-14 px-4 border-b border-white/[0.04]">
          <div className="flex items-center gap-2">
            <Logo size={28} />
            <div>
              <span className="text-white text-[11px] font-bold tracking-wider">STAFF PORTAL</span>
              <span className="block text-teal-400 text-[8px] font-semibold tracking-widest uppercase">GHL India</span>
            </div>
          </div>
