          ...
          <div ref={termsRef} className="flex-1 overflow-y-auto px-6 py-4"
            ...
            <div className={`prose prose-sm max-w-none ${isDark ? 'prose-invert' : ''}`}>
              ...
              {[
                ...
                { title: '4. SEBI Compliance', body: 'GHL India Ventures is a SEBI-registered Category II AIF (Reg: IN/AIF2/24-25/1517). All investment activities are conducted in compliance with SEBI (Alternative Investment Funds) Regulations, 2012 and subsequent amendments.' },
