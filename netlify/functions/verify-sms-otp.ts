/* ================================================================
   VERIFY SMS OTP — Netlify Serverless Function

   Checks the 6-digit code against the sms_otp_codes table.
   ================================================================ */
...
export default async (request: Request) => {
  ...
  try {
    ...
    if (cleanMobile.length !== 10 || !code || code.length !== 6) {
      return new Response(JSON.stringify({ error: 'Valid 10-digit mobile and 6-digit OTP required.' }), {
    ...
    // Find the most recent unverified code for this mobile
    ...
    console.error('[verify-sms-otp] Error:', message)
