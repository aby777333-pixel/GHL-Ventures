  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e5e5e5;">
      ...
      <div style="padding: 32px 24px;">
        <h2 style="color: #0A0A0A; font-size: 18px; margin-top: 0; margin-bottom: 16px;">Thank you, ${firstName}!</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 20px;">
          <tr><td style="padding: 6px 0; color: #888;">Phone</td><td style="padding: 6px 0;"><a href="tel:+917200255252" style="color: #D0021B; text-decoration: none;">+91 72002 55252</a></td></tr>
          <tr><td style="padding: 6px 0; color: #888;">Email</td><td style="padding: 6px 0;"><a href="mailto:ghlindiaventures@gmail.com" style="color: #D0021B; text-decoration: none;">ghlindiaventures@gmail.com</a></td></tr>
          <tr><td style="padding: 6px 0; color: #888;">WhatsApp</td><td style="padding: 6px 0;"><a href="https://wa.me/917200255252" style="color: #D0021B; text-decoration: none;">Chat with us</a></td></tr>
        </table>
        <div style="text-align: center; margin-top: 24px;">
          <a href="https://ghlindiaventures.com" style="display: inline-block; background: #D0021B; color: #fff; padding: 12px 28px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">Visit Our Website</a>
        </div>
      </div>
      <div style="background: #f9f9f9; padding: 16px; text-align: center; border-top: 1px solid #eee;">
        <p style="color: #999; font-size: 11px; margin: 0; line-height: 1.6;">
          ...
          <a href="https://ghlindiaventures.com/disclaimer" style="color: #999; text-decoration: underline;">Disclaimer</a> &bull;
          <a href="https://ghlindiaventures.com" style="color: #999; text-decoration: underline;">Website</a>
        </p>
      </div>
    </div>
  `
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!resendKey) {
      ...
      return NextResponse.json({ success: true, emailsSent: false, reason: 'No RESEND_API_KEY configured' })
    }
    ...
    return NextResponse.json({ success: true, emailsSent: true, sent, failed, clientNotified: clientEmails.length > 0 })
  } catch (err: unknown) {
