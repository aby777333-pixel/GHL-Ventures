...
export const BRAND: BrandData = {
  ...
  minInvestmentAIF: '1 Crore',
  minInvestmentDebenture: '10 Lakhs',
};
...
export const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  { id: 'fund_structure', category: 'fund', keywords: ['fund', 'structure', 'how does fund work', 'fund details'], response: 'Our fund operates through two routes. The Direct AIF Route requires a minimum of 1 Crore and gives you direct exposure to our portfolio of stressed assets and startups, targeting 15-25% IRR. The Debenture Route starts at just 10 Lakhs, offering secured debentures with 12-15% annual returns. Both are SEBI-regulated.', followUp: ['Compare the two routes', 'Which one is right for me?'], priority: 5, speaker: 'abe' },

  // Investment Routes
  { id: 'debenture', category: 'debenture', keywords: ['debenture', 'debenture route', 'ncd', '10 lakh', 'ten lakh', 'fixed income'], response: 'Our Debenture Route is perfect for investors looking for predictable returns with lower entry. Starting at just 10 Lakhs, you get secured Non-Convertible Debentures with target returns of 12-15% per annum. The tenure is typically 2-3 years. It is an excellent alternative to fixed deposits offering significantly higher returns.', followUp: ['How is this different from FD?', 'Is my capital safe?'], priority: 5, speaker: 'tina' },
  { id: 'direct_aif', category: 'aif', keywords: ['direct aif', 'category ii', 'direct route', '1 crore', 'one crore'], response: 'The Direct AIF Route is our flagship offering for HNIs. With a minimum investment of 1 Crore, you get direct exposure to our diversified portfolio of stressed real estate recoveries and high-growth startups. We target 15-25% IRR over a 5-7 year period. Your investment is managed by our experienced team of PE professionals.', followUp: ['What is the lock-in period?', 'How are returns distributed?'], priority: 5, speaker: 'abe' },
  { id: 'compare', category: 'fund', keywords: ['compare', 'difference', 'which is better', 'vs', 'comparison'], response: 'The key differences: Direct AIF needs 1 Crore minimum, targets 15-25% IRR over 5-7 years, and gives direct portfolio exposure. The Debenture Route needs only 10 Lakhs, offers 12-15% annual returns with 2-3 year tenure, and provides more predictable income. AIF is for growth-seeking HNIs; Debenture is for steady income seekers.', followUp: ['Which one is right for me?', 'Can I invest in both?'], priority: 5, speaker: 'abe' },

  // Returns & Risk
  { id: 'returns', category: 'fund', keywords: ['returns', 'irr', 'expected return', 'performance', 'yield', 'profit'], response: 'Our target returns vary by route. The Direct AIF targets 15-25% IRR over the fund lifecycle, primarily driven by stressed asset recovery and startup exits. The Debenture Route targets 12-15% per annum through secured fixed-income instruments. Past performance is not indicative of future results, but our portfolio is structured for optimal risk-adjusted returns.', followUp: ['How does this compare to FD?', 'What if the fund underperforms?'], priority: 4, speaker: 'abe' },
  ...
  { id: 'minimum', category: 'fund', keywords: ['minimum', 'minimum investment', 'how much', 'entry amount', 'starting amount'], response: 'We offer two entry points. The Direct AIF Route requires a minimum investment of 1 Crore as mandated by SEBI for Category II AIFs. If that feels like a big step, our Debenture Route starts at just 10 Lakhs, making institutional-grade investing more accessible. Both routes are SEBI-regulated.', followUp: ['Tell me about the Debenture Route', 'Is 1 Crore really the minimum?'], priority: 5, speaker: 'tina' },
  { id: 'kyc', category: 'process', keywords: ['kyc', 'documents', 'documentation', 'paperwork'], response: 'For KYC, you will need: PAN card, Aadhaar card, address proof, bank account details with cancelled cheque, passport-size photos, and net worth certificate from a CA for AIF investment. For the Debenture Route, the documentation is simpler. Our team will guide you through every step.', followUp: ['How long does KYC take?', 'Can I do this online?'], priority: 3, speaker: 'tina' },
  ...
  // Comparisons
  { id: 'fd_compare', category: 'fund', keywords: ['fixed deposit', 'fd', 'bank', 'mutual fund', 'better than fd', 'pms'], response: 'Compared to FDs yielding 6-7%, our Debenture Route targets 12-15% annually and our AIF targets 15-25% IRR. Unlike mutual funds, AIFs can access private market opportunities. Compared to PMS (min 50 Lakhs), our AIF offers more diversified strategies. The trade-off is higher minimum investment and longer lock-in periods.', followUp: ['Is it worth the risk?', 'What about liquidity?'], priority: 3, speaker: 'abe' },

  // Other
  { id: 'tenure', category: 'fund', keywords: ['tenure', 'lock in', 'how long', 'duration', 'period', 'maturity'], response: 'The Direct AIF has a typical tenure of 5-7 years with potential extension. The Debenture Route has a shorter tenure of 2-3 years. For the AIF, partial exits may be possible after 3 years depending on portfolio liquidity. The Debenture Route offers more predictable maturity dates.', followUp: ['Can I exit early?', 'What happens at maturity?'], priority: 3, speaker: 'abe' },
  ...
  { id: 'eligibility', category: 'process', keywords: ['eligible', 'who can invest', 'can i invest', 'qualification', 'hni'], response: 'For the Direct AIF, SEBI mandates a minimum investment of 1 Crore, making it suitable for High Net Worth Individuals. For the Debenture Route starting at 10 Lakhs, the eligibility criteria are more flexible. Both Indian residents and NRIs can invest. There is no maximum age limit. Institutional investors are also welcome.', followUp: ['Am I eligible?', 'What is an HNI?'], priority: 3, speaker: 'tina' },
];
...
INVESTMENT ROUTES:
1. Direct AIF: Min ${BRAND.minInvestmentAIF}, 15-25% target IRR, 5-7 year tenure, stressed real estate + startups
2. Debenture Route: Min ${BRAND.minInvestmentDebenture}, 12-15% p.a., 2-3 year tenure, secured NCDs
