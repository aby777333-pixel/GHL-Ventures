...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    response: '**Route Comparison:**\n\n| | Direct AIF | SEBI Co-Invest |\n|---|---|---|\n| **Min Investment** | As per SEBI Regs | Contact for Details |\n| **Target Returns** | 15\u201325% IRR | Attractive risk-adjusted |\n| **Best For** | HNIs, Family Offices | Salaried Professionals |\n| **Structure** | Direct fund units | SEBI co-invest framework |\n| **Risk Level** | Moderate-High | Moderate |\n\nBoth routes invest in the same quality portfolio. The difference is in structure and return profile.',
    followUp: ['Co-Invest Details', 'Direct AIF Details', 'Talk to Advisor'],
    priority: 8,
  },
  // ─── Minimum Investment ───
  {
    ...
    response: 'Our minimum investment depends on the route:\n\n\u2022 **Direct AIF Route:** As per SEBI AIF Regulations\n\u2022 **SEBI Co-Invest Framework:** Contact our team for details\n\nThe Co-Invest Framework was specifically designed to make alternative investments accessible to salaried professionals and families.',
    followUp: ['Co-Invest Framework', 'Direct AIF Route', 'How to Start'],
    priority: 9,
  },
  // ─── Process ───
  {
  ...
  // ─── FD Comparison ───
  {
    ...
    response: '**GHL Co-Invest vs Bank FD:**\n\n| Parameter | GHL Co-Invest | Bank FD |\n|---|---|---|\n| **Returns** | Attractive risk-adjusted | 6\u20137% p.a. |\n| **Min Amount** | Contact for Details | \u20B91,000 |\n| **SEBI Regulated** | Yes | RBI |\n| **Asset Backed** | Real estate + startups | Bank guarantee |\n\nThe SEBI Co-Invest Framework targets **meaningfully higher returns** than traditional FDs, with professional fund management.',
    followUp: ['Co-Invest Details', 'Risk Management', 'How to Start'],
    priority: 7,
  },
  // ─── Thank you / Bye ───
  {
