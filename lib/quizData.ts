...
export const RISK_PROFILES: RiskProfile[] = [
  {
    ...
    recommendation: 'The Debenture Route is ideal for you — structured returns backed by real assets, starting from just ₹10 Lakhs.',
    route: 'Debenture Route',
  ...
  },
  {
    ...
    recommendation: 'Both our investment routes could work for you. Start with the Debenture Route for stability, then consider the Direct AIF for growth.',
    route: 'Both Routes',
    routeLink: '/fund',
    color: '#F59E0B',
  },
  {
    ...
    recommendation: 'The Direct AIF Route targeting 15–25% IRR is designed for investors like you. Minimum ₹1 Crore commitment.',
